...
class Employee(models.Model):
    ...
    emergency_phone = fields.Char("Emergency Phone", groups="hr.group_hr_user", required = True)
    ...
    x_direction_id = fields.Many2one('hr.department', string='Structure')
    ...
    #code ajouté par Antoine SAMPEBGO
    hr_service = fields.Many2one("hr_service",string = "Service")
    x_unite_id = fields.Many2one("hr_unite",string = "Unité")
    x_section_id = fields.Many2one("hr_section",string = "Section")
